...
from .views import api_login, api_login_wx, api_login_by_phone, api_search_sheep, api_get_sheep_by_id, api_get_vaccine_records, api_get_breeders, api_search_goods, api_get_sheep_with_growth, api_check_token
